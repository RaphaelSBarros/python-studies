...
### Informar o login -> whirlpool.rhlar4
    try:
        ...
        loginSenior.send_keys("whirlpool.rhlar4")
        
        ### Clicar em Log On
        logOnBtn = driver.find_element(By.ID, "loginBtn")
        logOnBtn.click()
        
        ### Digitar a senha -> g0$07'Ve*&KN
        try:
            element = WebDriverWait(driver, 10).until( #espera até 10s para que o elemento especificado apareça
            ...
            passwdSenior.send_keys("g0$07'Ve*&KN")
